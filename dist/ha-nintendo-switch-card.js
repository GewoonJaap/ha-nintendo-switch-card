 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new A(t,e.slice(1),s).parts}if("@"===i)return[new U(t,e.slice(1),n.eventContext)];if("?"===i)return[new E(t,e.slice(1),s)];return new P(t,e,s).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const I=(t,...e)=>new S(t,e,"html",R)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const X={};class tt extends G{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,s)=>t.reduceRight(((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t)),s),s=e(t,new Set),n=[];s.forEach((t=>n.unshift(t))),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!Y){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new K(String(e),Z)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Y?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==X&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return X}}tt.finalized=!0,tt.render=(t,s,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const i=n.scopeName,r=M.has(s),o=j&&11===s.nodeType&&!!s.host,a=o&&!q.has(i),l=a?document.createDocumentFragment():s;if(((t,s,n)=>{let i=M.get(s);void 0===i&&(e(s,s.firstChild),M.set(s,i=new C(Object.assign({templateFactory:V},n))),i.appendInto(s)),i.setValue(t),i.commit()})(t,l,Object.assign({templateFactory:z(i)},n)),a){const t=M.get(l);M.delete(l);const n=t.value instanceof _?t.value.template:void 0;H(i,l,n),e(s,s.firstChild),s.appendChild(l),M.set(s,t)}!r&&o&&window.ShadyCSS.styleElement(s.host)},tt.shadowRootOptions={mode:"open"};var et=["second","minute","hour","day","week","month","year"];var st=["秒","分钟","小时","天","周","个月","年"];var nt={},it=function(t,e){nt[t]=e},rt=[60,60,24,7,365/7/12,12];function ot(t){return t instanceof Date?t:!isNaN(t)||/^\d+$/.test(t)?new Date(parseInt(t)):(t=(t||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([+-]\d\d):?(\d\d)/," $1$2"),new Date(t))}var at,lt=function(t,e,s){var n=function(t,e){return(+(e?ot(e):new Date)-+ot(t))/1e3}(t,s&&s.relativeDate);return function(t,e){for(var s=t<0?1:0,n=t=Math.abs(t),i=0;t>=rt[i]&&i<rt.length;i++)t/=rt[i];return(t=Math.floor(t))>(0==(i*=2)?9:1)&&(i+=1),e(t,i,n)[s].replace("%s",t.toString())}(n,function(t){return nt[t]||nt.en_US}(e))};it("en_US",(function(t,e){if(0===e)return["just now","right now"];var s=et[Math.floor(e/2)];return t>1&&(s+="s"),[t+" "+s+" ago","in "+t+" "+s]})),it("zh_CN",(function(t,e){if(0===e)return["刚刚","片刻后"];var s=st[~~(e/2)];return[t+" "+s+"前",t+" "+s+"后"]})),function(t){t.OFFLINE="OFFLINE",t.INACTIVE="INACTIVE",t.ONLINE="ONLINE",t.PLAYING="PLAYING"}(at||(at={})),console.info("%c  ha-nintendo-switch-card \n%c  1.1.0   ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-nintendo-switch-card",name:"HA Nintendo Switch Card",description:"A card to show Nintendo Switch integrations"});let ct=class extends tt{static get properties(){return{hass:{},config:{}}}render(){return I`
    ...
    `}setConfig(t){if(!t.entities&&!t.entity)throw new Error("You need to define either a single entity or an entities field");this.config=t}getCardSize(){return this.config.entities?this.config.entities.length+1:2}_toggle(t){this.hass.callService("homeassistant","toggle",{entity_id:t.entity_id})}createEntitiesCard(t){if("string"==typeof t){const e=[];Object.values(this.hass.states).forEach((s=>{s.entity_id.startsWith(t)&&e.push(s.entity_id)})),t=e}if(this.config.online_only){const e=[];t.forEach((t=>{const s=this.hass.states[t];s&&s.attributes.presence.state&&s.attributes.presence.state!==at.OFFLINE&&e.push(t)})),t=e}return[I` <div class="card-header"><div class="name">Nintendo Friends</div></div> `,...t.map(((e,s)=>{var n;const i=this.hass.states[e];return i?I`
              <div
              ...
              >
                ...
                ${i.attributes.presence.game&&this.config.game_background?I` <img src="${i.attributes.presence.game.imageUri}" class="ha-nintendo-switch-game-bg" /> `:""}
              </div>
            `:I` <div class="not-found">Entity ${e} not found.</div> `}))]}handlePopup(t){const e=t.entity_id,s=new Event("hass-more-info",{composed:!0});s.detail={entityId:e},this.dispatchEvent(s)}createEntityCard(t){return I`
    ...
    `}formatLastOnline(t){return lt(new Date(1e3*t))}formatPlaytime(t){const e=60*t,s=Math.floor(e/86400),n=Math.floor(e%86400/3600),i=Math.floor(e%3600/60),r=Math.floor(e%60);let o=(s>0?s+(1==s?" day, ":" days, "):"")+(n>0?n+(1==n?" hour, ":" hours, "):"")+(i>0?i+(1==i?" minute, ":" minutes, "):"")+(r>0?r+(1==r?" second":" seconds"):"");return o=o.replace(/,\s*$/,""),o=o.replace(/\w\S*/g,(function(t){return t.charAt(0).toUpperCase()+t.substr(1).toLowerCase()})),o||"0 minutes"}renderUserAvatar(t){return t.attributes.imageUri?I` <img src="${t.attributes.imageUri}" class="ha-nintendo-switch-avatar" /> `:I` <ha-icon icon="${t.attributes.imageUri}" class="ha-nintendo-switch-avatar"></ha-icon> `}renderCurrentlyPlayingGame(t){const e=t.attributes.presence.game;return(null==e?void 0:e.name)?I`
          <div class="ha-nintendo-switch-now-playing">
            ...
            <div class="ha-nintendo-switch-last-online">
              ...
              <span> ${this.formatPlaytime(t.attributes.presence.game.totalPlayTime)} </span>
            </div>
            <img class="game-img" src="${e.imageUri}" />
          </div>
        `:I``}static get styles(){return Q`
      .card-header {
        width: 100%;
        padding-top: 8px;
        padding-bottom: 8px;
