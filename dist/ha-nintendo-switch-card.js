 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new k(t,e.slice(1),s).parts}if("@"===i)return[new U(t,e.slice(1),n.eventContext)];if("?"===i)return[new E(t,e.slice(1),s)];return new C(t,e,s).parts}handleTextExpression(t){return new N(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const X={};class tt extends G{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,s)=>t.reduceRight(((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t)),s),s=e(t,new Set),n=[];s.forEach((t=>n.unshift(t))),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!Y){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new K(String(e),Z)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Y?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==X&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return X}}tt.finalized=!0,tt.render=(t,s,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const i=n.scopeName,r=R.has(s),o=L&&11===s.nodeType&&!!s.host,a=o&&!F.has(i),l=a?document.createDocumentFragment():s;if(((t,s,n)=>{let i=R.get(s);void 0===i&&(e(s,s.firstChild),R.set(s,i=new N(Object.assign({templateFactory:O},n))),i.appendInto(s)),i.setValue(t),i.commit()})(t,l,Object.assign({templateFactory:I(i)},n)),a){const t=R.get(l);R.delete(l);const n=t.value instanceof _?t.value.template:void 0;H(i,l,n),e(s,s.firstChild),s.appendChild(l),R.set(s,t)}!r&&o&&window.ShadyCSS.styleElement(s.host)},tt.shadowRootOptions={mode:"open"};var et=["second","minute","hour","day","week","month","year"];var st=["秒","分钟","小时","天","周","个月","年"];var nt={},it=function(t,e){nt[t]=e},rt=[60,60,24,7,365/7/12,12];function ot(t){return t instanceof Date?t:!isNaN(t)||/^\d+$/.test(t)?new Date(parseInt(t)):(t=(t||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([+-]\d\d):?(\d\d)/," $1$2"),new Date(t))}var at=function(t,e,s){var n=function(t,e){return(+(e?ot(e):new Date)-+ot(t))/1e3}(t,s&&s.relativeDate);return function(t,e){for(var s=t<0?1:0,n=t=Math.abs(t),i=0;t>=rt[i]&&i<rt.length;i++)t/=rt[i];return(t=Math.floor(t))>(0==(i*=2)?9:1)&&(i+=1),e(t,i,n)[s].replace("%s",t.toString())}(n,function(t){return nt[t]||nt.en_US}(e))};it("en_US",(function(t,e){if(0===e)return["just now","right now"];var s=et[Math.floor(e/2)];return t>1&&(s+="s"),[t+" "+s+" ago","in "+t+" "+s]})),it("zh_CN",(function(t,e){if(0===e)return["刚刚","片刻后"];var s=st[~~(e/2)];return[t+" "+s+"前",t+" "+s+"后"]})),console.info("%c  ha-nintendo-switch-card \n%c  0.0.0-development   ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-nintendo-switch-card",name:"HA Nintendo Switch Card",description:"A card to show Nintendo Switch integrations"});let lt=class extends tt{static get properties(){return{hass:{},config:{}}}render(){return j`
    ...
    `}setConfig(t){if(!t.entities&&!t.entity)throw new Error("You need to define either a single entity or an entities field");this.config=t}getCardSize(){return this.config.entities?this.config.entities.length+1:2}_toggle(t){this.hass.callService("homeassistant","toggle",{entity_id:t.entity_id})}createEntitiesCard(t){if("string"==typeof t){const e=[];Object.values(this.hass.states).forEach((s=>{s.entity_id.startsWith(t)&&e.push(s.entity_id)})),t=e}if(this.config.online_only){const e=[];t.forEach((t=>{const s=this.hass.states[t];s&&s.attributes.presence.state&&"offline"!==s.attributes.presence.state.toLowerCase()&&e.push(t)})),t=e}return[j` <div class="card-header"><div class="name">Nintendo Friends</div></div> `,...t.map(((e,s)=>{var n;const i=this.hass.states[e];return i?j`
              <div
...
*/lt=function(t,e,s,n){var i,r=arguments.length,o=r<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,s):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,s,n);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(o=(r<3?i(o):r>3?i(e,s,o):i(e,s))||o);return r>3&&o&&Object.defineProperty(e,s,o),o}([(ct="ha-nintendo-switch-card",t=>"function"==typeof t?((t,e)=>(window.customElements.define(t,e),e))(ct,t):((t,e)=>{const{kind:s,elements:n}=e;return{kind:s,elements:n,finisher(e){window.customElements.define(t,e)}}})(ct,t))],lt);
